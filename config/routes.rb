...
CanvasRails::Application.routes.draw do
  ...
  resources :courses do
    ...
    get 'modules/items/:id/embedded' => 'context_modules#item_embedded', as: :context_modules_item_embedded
  ...
  get 'login' => 'pseudonym_sessions#pre_login'
  get 'login2' => 'pseudonym_sessions#new'
  get 'login/resolve' => 'pseudonym_sessions#resolve_login', as: :resolve_login
  ...
  ApiRouteSet::V1.draw(self) do
    scope(controller: :courses) do
      ...
      get 'courses_by_date', action: :index_by_date, as: 'courses_by_date'
