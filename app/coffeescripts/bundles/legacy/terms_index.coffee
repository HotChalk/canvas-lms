      ...
      success: (data) ->
        ...
        for idx of term.enrollment_dates_overrides
          ...
          if override.start_at
            start_string = $.datetimeString(override.start_at, dateOpts)
          ...
          term[type_string + "_end_at"] = $.datetimeString(override.end_at, dateOpts) or I18n.t("date.term_end", "term end")
        ...
        term.start_at = $.datetimeString(term.start_at, dateOpts) or I18n.t("date.unspecified", "whenever")
        term.end_at = $.datetimeString(term.end_at, dateOpts) or I18n.t("date.unspecified", "whenever")
