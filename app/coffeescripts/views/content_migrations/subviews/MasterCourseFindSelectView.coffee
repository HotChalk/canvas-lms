define [
  ...
  'jst/content_migrations/subviews/MasterCourseFindSelect'
  'jst/courses/autocomplete_item'
  'jquery.ajaxJSON'
  'jquery.disableWhileLoading'
  'jqueryui/autocomplete'
], ($, Backbone, _, I18n, template, autocompleteItemTemplate) ->
  class MasterCourseFindSelectView extends Backbone.View
    ...
    validations: ->
      ...
      unless settings?.source_course_id
        errors.courseSearchField = [
          type: "required"
          message: I18n.t("You must select a source course to copy groups from")
        ]
      errors
