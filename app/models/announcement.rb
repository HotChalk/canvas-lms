...
class Announcement < DiscussionTopic
  ...
  set_broadcast_policy! do
    ...
    to { users_with_permissions(active_participants_with_visibility - [user]) }
    whenever { |record|
  ...
  set_policy do
    ...
    given { |user, session| self.context.grants_right?(user, session, :manage_announcements) } #admins.include?(user) }
